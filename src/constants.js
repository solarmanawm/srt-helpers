...
const constants = module.exports = Object.freeze({
    ...
    PARTNERS_PAGES(app) {
        const navigation = [
            {
                title: app.$t('suppliersGoods'),
                link: constants.PARTNERS_LINKS.partners,
                exact: true,
                hide: !app.$store.getters.isRussia,
            },
            {
                title: app.$t('EDI.decryption'),
                link: constants.PARTNERS_LINKS.EDI,
                exact: true,
                hide: !app.$store.getters.isRussia,
            },
            {
                title: app.$t('serviceProviders'),
                link: constants.PARTNERS_LINKS.serviceProviders,
                exact: true,
                hide: !app.$store.getters.isRussia,
            },
            {
                title: app.$t('purchases'),
                link: constants.PARTNERS_LINKS.purchases,
                exact: true,
                hide: !app.$store.getters.isRussia,
            },
            {
                title: app.$t('landlords'),
                link: constants.PARTNERS_LINKS.landlords,
                exact: true,
                hide: !app.$store.getters.isRussia,
            },
            {
                title: app.$t('franchising'),
                link: constants.PARTNERS_LINKS.franchising,
                exact: true,
                hide: !app.$store.getters.isRussia,
            },
            {
                title: app.$t('otherTypesCooperation'),
                link: constants.PARTNERS_LINKS.other,
                exact: true,
                hide: !app.$store.getters.isRussia,
            },
        ];

        return navigation.filter(page => !page.hide);
    },
    ...
    WORK_PAGES(app) {
        return [
            {
                title: app.$t('workInStore'),
                link: constants.WORK_LINKS.store,
                exact: false,
            },
            {
                title: app.$t('workInWarehouse'),
                link: constants.WORK_LINKS.warehouse,
                exact: false,
            },
            {
                title: app.$t('workInOffice'),
                link: constants.WORK_LINKS.office,
                exact: false,
            },
            {
                title: app.$t('workInIt'),
                link: constants.WORK_LINKS.it,
                exact: false,
                external: true,
            },
            {
                title: app.$t('probation'),
                link: constants.WORK_LINKS.probation,
                exact: true,
            },
            {
                title: app.$t('contacts'),
                link: constants.WORK_LINKS.contacts,
                exact: true,
            },
        ];
    },
    ...
    ABOUT_PAGES(app) {
        const navigation = [
            {
                title: app.$t('aboutNav[0]'),
                link: constants.ABOUT_LINKS.about,
                exact: true,
            },
            {
                title: app.$t('aboutNav[1]'),
                link: constants.ABOUT_LINKS.business,
                exact: true,
                hide: app.$store.getters.isLatvia,
            },
            {
                title: app.$t('help'),
                link: constants.ABOUT_LINKS.help,
                exact: false,
                hide: !(app.$store.getters.isRussia || app.$store.getters.isKazakhstan || app.$store.getters.isBelarus),
            },
            {
                title: app.$t('aboutNav[3]'),
                link: constants.ABOUT_LINKS.contacts,
                exact: true,
            },
            {
                title: app.$t('aboutNav[4]'),
                link: constants.ABOUT_LINKS.press,
                exact: false,
                hide: !app.$store.getters.isRussia,
                external: true,
            },
            {
                title: app.$t('qualityControl'),
                link: constants.ABOUT_LINKS.qualityControl,
                exact: false,
                hide: !app.$store.getters.isRussia,
            },
        ];
    ...
    TRANSACTION: {
        paymentIncrease: 2, // попкупка с начислением
        paymentDecrease: 3, // покупка со списанием
        refund: 7, // возврат
        settingPoints: 8, // Начисление баллов
        charityPointsDebiting: 11, // списание баллов на благотворительность
    },
